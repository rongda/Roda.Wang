    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + '"><i class="'+'iconfont arrowdown trans'+'"></i></div><div class="' + SLIDES_ARROW_NEXT + '"><i class="'+'iconfont arrowdown trans'+'"></i></div>');
            if(options.controlArrowColor!='#fff'){
                /*
                section.find(SLIDES_ARROW_NEXT_SEL).css('border-color', 'transparent transparent transparent '+options.controlArrowColor);
                section.find(SLIDES_ARROW_PREV_SEL).css('border-color', 'transparent '+ options.controlArrowColor + ' transparent transparent');
                */
                section.find(SLIDES_ARROW_NEXT_SEL).css('border-color', options.controlArrowColor);
                section.find(SLIDES_ARROW_PREV_SEL).css('border-color', options.controlArrowColor);
            }
